...
@section('content')
    ...
    <section style="padding-top:100px;"id="team" class="team section-bg">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>{{ __('Our Team') }}</h2>
                <p>"Our Team - A united force driving excellence together, embracing diversity and fostering a positive work
                    culture to achieve remarkable results

                    . Our dedicated and passionate team collaborates with mutual respect, valuing each other's unique skills
                    and experiences

                    . Together, we strive to make a positive impact, overcoming challenges and celebrating success as one
                    cohesive unit."</p>
            </div>
            <div class="row justify-content-around">
                @if ($teamCount)
                    ...
                    @endforeach
                @else
                    <h6 class="text-center">{{ __('There is no User yet') }}</h6>
                    <hr>
                @endif
            </div>
        </div>
    ...
    <section id="skills" class="skills">
        <div class="container">
            ...
            <div class="section-title" data-aos="fade-up">
                <h2>{{ __('Our Skills') }}</h2>
                <p>With proficiency in these technologies, we are well-equipped to take on diverse challenges and deliver
                    exceptional solutions for our clients."</p>
            </div>
