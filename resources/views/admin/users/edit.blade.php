        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    @if ($user->image)
                    <img class="img-account-profile rounded-circle mb-2" style="width:190px;" src="{{ asset($user->image) ?? asset('image/user-128.png') }}" alt="{{ $user->name }}`image">
                    @endif
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control " disabled id="disabledTextInput" type="email" name="email" placeholder="Enter your email address" value="{{ $user->email }}">
                        </div> 

                        <div class="mb-3">
                            <label class="small mb-1" for="inputUsername">{{ __('IS_admin') }}</label>
                            <select name="is_admin" class="form-control @error('is_admin') is-invaled @enderror" required>
                                <option class="text-success text-bold" value="0">Not Admin</option>
                                <option class="text-success font-weight-bold" value="1">Admin </option>
                              </select>               
                         </div>
                        @error('is_admin')
                            <div class="alert alert-danger" >
