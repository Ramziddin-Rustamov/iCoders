...
<section class="h-100 gradient-custom-2" style="padding-top:125px;">
    <div class="container pb-5 h-100">
      ...
      <div class="row d-flex justify-content-center align-items-center h-100">
        ...
        <h6 class="text-success">{{ __('Public view') }}</h6><hr>
          <div class="card">
            <div class="rounded-top text-white d-flex flex-row" style="background-color: #000; height:200px;">
              <div class="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                <img class="img-fluid img-thumbnail mt-4 mb-2" style="width: 150px; z-index: 1" src="{{ asset($user->image) ?? asset('image/user-128.png') }}" alt="{{ $user->name }}`image">
              ...
              <div class="ms-3" style="margin-top: 130px;">
                <h5>{{ $user->name }}</h5>
                <p>{{ $user->location ?? 'Update your location' }}</p>
              </div>
            </div>
